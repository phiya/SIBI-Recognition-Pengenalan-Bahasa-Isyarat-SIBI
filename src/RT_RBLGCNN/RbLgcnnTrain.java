...
public class RbLgcnnTrain {
    ...
    public static double RbGVarians;
    public static int RbEpochs;
...
//        tool.printArray(DataTraining);
        ...
        WR.writeToCSV(SizeDataTraining, RTM.DirSizeDatatraining);
        WR.writeToCSV(DataTraining, RTM.DirDataTraining);
...
//                    System.out.println();
                ...
                WR.writeToCSV(K, RTM.DirK);
//                System.out.println("\nHasil RbNormalisasi Layer :");
...
//                System.out.println("Error Derivatif = " + df.format(Error_Derivatif));
                ...
                WR.writeToCSV(Varians[DataTraining.length - 1], RTM.DirVarianRT);
...
//                Max = MaxL.get(Iterasi);
            ...
            WR.writeToCSV(Ymax, RTM.DirYmaxRT);
