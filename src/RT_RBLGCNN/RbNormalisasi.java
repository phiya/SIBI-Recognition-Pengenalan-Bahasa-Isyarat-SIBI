...
public class RbNormalisasi {
    ...
    public double[][] NormalisasiTrain(double[][] Data) {
...
//        tool.printArray(Min);
        ...
        WR.writeToCSV(MinMax, RTM.DirMinMax);
...
//        printArray(HasilNormalisasi);
    ...
    public double[][] NormalisasiTest(double[][] Data) throws IOException{
        ...
        MinMaxCSV = WR.ReadCSV(RbF.PathMinMax);
